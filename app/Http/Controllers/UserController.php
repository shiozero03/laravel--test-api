...
class UserController extends Controller
{
	...
	public function updatePictureProfile(Request $request){
    	...
    	if ($validated->fails()) {
			...
			return new BaseResource('success', 200, 'Foto profil user berhasil diperbarui', $result);
		}
	}
	public function updatePasswordUser(Request $request){
    	...
    	if ($validated->fails()) {
	    	...
	    	if($result == null){
	    		return new BaseResource('error', 422, 'Password user gagal diperbarui', null, 'Password lama tidak sesuai');	
	    	}
